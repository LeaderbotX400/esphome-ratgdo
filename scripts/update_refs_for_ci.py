...
RATGDO_REPO = "LeaderbotX400/esphome-leaderbotx400"
    ...
    if "/pull/" in github_ref:
        ...
        if github_event_path and os.path.exists(github_event_path):
            with open(github_event_path) as f:
                ...
                repo = head.get("repo", {})
                fork_repo = repo.get("full_name")  # e.g., "someuser/esphome-leaderbotx400"
...
def main():
    ...
    for yaml_file in project_root.glob("*.yaml"):
        ...
        if (
            ...
            and "LeaderbotX400/esphome-leaderbotx400" in content
        ):
            # Replace the git source with local source, preserving indentation
            # This matches the exact structure: type: git, url: ..., ref: ...
            content = re.sub(
                r"type:\s*git\s*\n(\s+)url:\s*https://github\.com/LeaderbotX400/esphome-leaderbotx400\s*\n\s+ref:\s*\w+",
        ...
        if "remote_package:" in content and "LeaderbotX400/esphome-leaderbotx400" in content:
