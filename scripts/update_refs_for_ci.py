...
RATGDO_REPO = "LeaderbotX400/esphome-ratgdo"
...
def main():
    ...
    for yaml_file in project_root.glob("*.yaml"):
        ...
        if (
            ...
            and "LeaderbotX400/esphome-ratgdo" in content
        ):
        ...
        if "remote_package:" in content and "LeaderbotX400/esphome-ratgdo" in content:
